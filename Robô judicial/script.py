...
class Script:
	def __init__(self):
		self.__pesquisa = input("Digite o nome a ser pesquisado:\n")
		self.__pesquisa = f'{self.__pesquisa} processos'
		...
		barra.send_keys(self.__pesquisa)
	...
	def get_nome_pesquisado(self):
		return self.__pesquisa.replace(" processos","")
